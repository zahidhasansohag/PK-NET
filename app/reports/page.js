      ...
      <aside className="w-full lg:w-72 bg-gradient-to-br from-indigo-900 via-blue-900 to-indigo-950 text-white p-6 lg:min-h-screen hidden lg:flex flex-col shadow-2xl">
        <div className="flex-1">
          ...
          <nav className="space-y-4">
            ...
            <a href="/routers" className="block py-3 px-4 hover:bg-white/10 rounded-xl transition-all">রাউটার সেটিং</a>
          </nav>
        </div>
      </aside>
      ...
      <main className="flex-1 p-4 md:p-10 w-full max-w-[1600px] mx-auto overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            ...
            <p className="text-slate-500 mt-1">আপনার ব্যবসার আয় এবং পারফরম্যান্স ট্র্যাক করুন</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {[
            { label: 'আজকের আয়', val: '৳ ১,৮৫০', trend: '+১২%', color: 'from-blue-500 to-indigo-600' },
            { label: 'সাপ্তাহিক আয়', val: '৳ ১২,৪০০', trend: '+৮%', color: 'from-purple-500 to-indigo-600' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
            ...
            <div className="h-[350px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={dailyData}>
                  ...
                  <Tooltip contentStyle={{ borderRadius: '16px', border: 'none', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)' }} cursor={{ stroke: '#6366f1', strokeWidth: 2 }} />
          ...
          <div className="bg-white p-6 md:p-8 rounded-[2.5rem] shadow-sm border border-slate-100 flex flex-col">
            ...
            <div className="h-[300px] w-full flex-1">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={packageData} cx="50%" cy="50%" innerRadius={60} outerRadius={100} paddingAngle={8} dataKey="value">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
          <div className="p-8 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="relative max-w-xs w-full">
              <input
                type="text"
                placeholder="ইউজার দিয়ে খুঁজুন..."
                value={searchQuery}
            ...
            <table className="w-full text-left">
              <thead className="bg-slate-50 text-slate-500 text-xs uppercase tracking-wider">
                <tr>
                  ...
                  <th className="px-8 py-4 font-bold">আয়</th>
                  <th className="px-8 py-4 font-bold">তারিখ ও সময়</th>
              ...
              <tbody className="divide-y divide-slate-50">
                {filteredHistory.map((t) => (
                  <tr key={t.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-8 py-5 text-slate-500 text-sm">{t.date} <span className="mx-2 text-slate-300">|</span> {t.time}</td>
          ...
          {filteredHistory.length === 0 && (
            <div className="p-20 text-center text-slate-400">
              <p>দুঃখিত, কোনো ট্রানজ্যাকশন পাওয়া যায়নি!</p>
            </div>
          )}
        </div>
